...
THIS IS A MINIMAL version of the EEGLAB toolbox distributed with the SASICA toolbox.

It is meant to be used when using SASICA for fieldtrip (i.e. ft_SASICA.m).
